...
const OrdRecientes = () => {
  ...
  if (!usuarioActual || !ordenes) {
    return <div>Cargando...</div>;
  }

  const combinedData = ordenes
    .filter(order => order.UserId === usuarioActual.id)
    .map(order => ({
      ...order,
      ...
      <div className="main-container">
        ...
        <div className="content">
          <div className="ordenes-container">
            <h3>Órdenes recientes de {usuarioActual.nombre}</h3>
